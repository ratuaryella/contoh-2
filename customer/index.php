...
<div class="w3-third">
  ...
  <h3>Kantin</h3><br>
  <i class="fa fa-cutlery w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>Pesan Makanan dan Minuman</p>
  <p>Pesan Tempat Duduk</p>
  <a class="w3-button w3-theme">Pilih</a>
  </div>
</div>
...
<div class="w3-third">
  ...
  <p>Beli Pulsa</p>
  <p>Pesan Barang dan Snack</p>
  <p>Pengantaran Paket</p>
  <a class="w3-button w3-theme">Pilih</a>
  </div>
</div>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
  <h3>Akademik</h3><br>
  <i class="fa fa-bookmark w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>Booking Ruangan</p>
  <a class="w3-button w3-theme">Pilih</a>
  </div>
</div>
